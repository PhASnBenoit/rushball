...
typedef enum etats_pupitre {
    ETAT_PUPITRE_CHOIX_MENU=0x00,
    ETAT_PUPITRE_VALIDE_AFFICHER_SCORES=0x10,
    ETAT_PUPITRE_SCORES_ATTENTE_RETOUR,
    ETAT_PUPITRE_MENU_PENALITE=0x20,
    ETAT_PUPITRE_PENALITE_NO_JOUEUR,
    ETAT_PUPITRE_PENALITE_ATTENTE_RETOUR,
    ETAT_PUPITRE_MENU_AQUILETOUR=0x30,
    ETAT_PUPITRE_AQUILETOUR_NO_JOUEUR,
    ETAT_PUPITRE_AQUILETOUR_ATTENTE_RETOUR,
    ETAT_PUPITRE_MENU_CORRIGER=0x40,
    ETAT_PUPITRE_CORRIGER_NO_JOUEUR,
    ETAT_PUPITRE_CORRIGER_SAISIE,
    ETAT_PUPITRE_CORRIGER_ATTENTE_RETOUR,
    ETAT_PUPITRE_MENU_SORTIR = 0x50,
    ETAT_PUPITRE_HORS_MENU=0x100
} T_ETATS_PUPITRE;
